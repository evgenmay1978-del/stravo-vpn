...
отображение хедера подписки. Изменения подготовлены для 1.0.7 (8), сборка впереди;
готовность на физическом устройстве не заявлена. Краткие связи и решения — в графе.

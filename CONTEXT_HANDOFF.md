...
## Актуальная сборка 19.09.2026 — 1.0.2
...
- Ветка `codex/stravo-premium-interface-20260919`, [PR #4](https://github.com/evgenmay1978-del/stravo-vpn/pull/4) открыт как draft, в `main` не слит. Публичный релиз пока только `v1.0.0`; финальный APK 1.0.2 доступен локально и в артефакте указанной сборки.

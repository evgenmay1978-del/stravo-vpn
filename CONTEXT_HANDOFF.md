...
## Обновление интерфейса 19.09.2026
...
- Итоговый APK установлен в отдельный чистый Android-эмулятор с ARM-трансляцией. Главная, профиль, настройки и локации открыты и просмотрены; сохранены четыре скриншота. Экран показывает отсутствие подписки и реальные пустые метрики. Подключение VPN не запускалось. Физическое TV в этой сессии недоступно.

...
## Реализация полноценного клиента — 21.09.2026
...
Написанные функции пока не объявлять проверенными: сборка и физический VPN-проход
ещё впереди. Исследование ниже — исходные факты, не новое ограничение на уже
